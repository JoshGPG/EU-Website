...
add_action( 'after_setup_theme', 'essence_register_responsive_menus' );
/**
 * Registers responsive menus.
 *
 * @since 1.5.3 Moved from file root to prevent notices about using translations
 * before the after_setup_theme hook under WP 6.7+.
 */
function essence_register_responsive_menus() {
...
add_action( 'after_setup_theme', 'essence_register_default_headers' );
/**
 * Registers default headers.
 *
 * @since 1.5.4 Moved from file root to prevent notices about using translations
 * before the after_setup_theme hook under WP 6.7+.
 */
function essence_register_default_headers() {
