...
* Fixed: prevent "_load_textdomain_just_in_time was called incorrectly" notices by calling register_default_headers in after_setup_theme. 

= 1.5.3 =

* Fixed: Prevent PHP notices about using translations before the after_setup_theme hook under WP 6.7+ by deferring registration of responsive menus.
