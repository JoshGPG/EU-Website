            ...
            <div class="event-card">
                <?php if ($date) : ?>
                    <div class="event-date-badge">
                        <span class="event-month"><?php echo esc_html(date_i18n('M', strtotime($date))); ?></span>
                        <span class="event-day"><?php echo esc_html(date_i18n('j', strtotime($date))); ?></span>
                    </div>
                <?php endif; ?>
                ...
                <div class="event-card-content">
                    ...
                    <div class="event-card-meta">
                        ...
                        <?php if ($location) : ?>
                            <span class="event-card-location"><?php echo esc_html($location); ?></span>
                        <?php endif; ?>
                    </div>
